...
def Create_nets():
    ...
    return generator, discriminator_clear, discriminator_blur, discriminator_output
...
def train_model(image_dir, mask_dir, gt_dir, mask2_dir, epochs, batch_size, learning_rate, model_save_path):
    ...
    generator, discriminator_clear, discriminator_blur, discriminator_output = Create_nets()
    ...
    min_loss = 100
    lambda_gp = 10
    ssim_loss_with_threshold = SSIMLossWithThreshold(threshold=0.1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mask_dir', type=str, default='/home/oscar/Desktop/SG/target_map')
