...
for i in pbar:
    ...
    if i%1000==0:
        ...
        with open("output_log.txt", "a") as file:
            output = "\r[Batch%d]-[Total_loss:%f]-[Dloss:-,Dloss2:-]-[mse:%f, loss_GAN1:%f, loss_GAN2:%f]" %\
            (i,loss_G.data.cpu(),
             mse.data.cpu(), loss_GAN1.data.cpu(),loss_GAN2.data.cpu())
