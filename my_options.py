...
class TrainOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--path_clear', type=str, default='../dataset/SG_dataset/dataset/train_data/FCFB/FC',
                                 help='dir of the clear dataset')
        self.parser.add_argument('--path_blur', type=str, default='../dataset/SG_dataset/dataset/train_data/FCFB/FB',
                                 help='dir of the blur dataset')
        # self.parser.add_argument('--path_gt', type=str, default='/home/oscar/Desktop/dataset/DPDD/dd_dp_dataset_png/train_c/source',
        #                          help='dir of the gt dataset')
        self.parser.add_argument('--path_gt', type=str, default='/home/oscar/Desktop/SG/results_0423/blurred_target',
                                 help='dir of the gt dataset')
        
        self.parser.add_argument('--path_mask', type=str, default='/home/oscar/Desktop/0301_dpdd_seg/dpdd_seg_mask_copy',
                                 help='dir of the mask dataset')
        
        self.parser.add_argument('--dataset_name', type=str, default="0312_DPDD", help='name of the dataset')
        self.parser.add_argument('--batch_size', type=int, default=8, help='size of the batches')
        self.parser.add_argument('--lr', type=float, default=0.00005, help='adam: learning rate')
