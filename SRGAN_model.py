...
class SRResNet(nn.Module):
    ...
    def __init__(self, large_kernel_size=9, small_kernel_size=3, n_channels=64, n_blocks=8, scaling_factor=2):
        """
        ...
        # The first convolutional block
        self.conv_block1 = ConvolutionalBlock(in_channels=4, out_channels=n_channels, kernel_size=large_kernel_size,
    ...
    def forward(self, lr_imgs, mask):
        ...
        """
        lr_imgs = torch.cat([lr_imgs, mask], dim=1)
...
class Generator(nn.Module):
    ...
    def forward(self, lr_imgs, mask):
        ...
        :return: super-resolution output images, a tensor of size (N, 3, w * scaling factor, h * scaling factor)
        """
        sr_imgs = self.net(lr_imgs, mask)  # (N, n_channels, w * scaling factor, h * scaling factor)
